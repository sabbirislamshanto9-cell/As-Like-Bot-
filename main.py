...
async def reply_editable_content(message, key, reply_markup=None, **values):
    """Send an editable content item while preserving Premium/Custom Emoji entities."""
    ...
    return await message.reply_text(format_bold(text), reply_markup=reply_markup)
...
EDIT_LABELS={
    ...
    "like_history":"⭐ Like History","order_history":"📜 Order History","auto_package":"Auto Like Package",
    "bonus_200":"200 Like Bonus",
...
async def create_bohudur_payment(user, amount):
    ...
    payload = {
        "full_name": (user.full_name or user.first_name or f"Telegram User {user.id}")[:120],
...
async def help_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_admin(user.id):
        text = (
            ...
            f"/botedit - Edit bot notices/messages\n"
            f"/editallow <userid> - Give edit permission\n"
            f"/editremove <userid> - Remove edit permission\n"
        ...
        text = (
            ...
            f"⚠️ Rules:\n"
            f"• Daily Free Like limit সর্বোচ্চ 50 Likes\n"
            f"• VIP ব্যবহারকারীরা VIP সময়ের মধ্যে সীমাহীন লাইক নিতে পারবেন\n"
            f"• Reset at 4:00 AM daily\n"
            f"• Daily Free Like-এর জন্য Official Group/Channel-এ Join করুন\n"
